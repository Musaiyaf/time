...
<body>
  ...
  <div class="card">
    ...
    <form id="f" onsubmit="return save(event)">
      ...
      <input type="text" id="tzsearch" list="tzoptions" placeholder="Search your city/country..." autocomplete="off">
      <datalist id="tzoptions"></datalist>
      <div id="tzresolved" class="sub" style="margin:4px 0 0"></div>

      <details>
        <summary>Advanced: POSIX time zone string &amp; NTP</summary>
        <label>POSIX time zone string (auto-filled by the search above, or type your own)</label>
